...
<p>As with most startups, the lead designer was time-constrained and needed some help shipping features and quality of life upgrades. We agreed upon a backlog of projects that were loosely scoped, and were optimizing for speed. Over a period of 2 months, the goal was to have design specs for a good number of feature upgrades and papercut-fixes in the backlog for whichever engineer had extra bandwidth. For this reason, it was important to have clear design specs and a clear line of thinking. Here\u2019s one example of a project:</p>

<h2>Dynamic Strings</h2>

<h3>Challenge</h3>
<p>In an all-in-one community app like Fedi, members are often sending strings of data to each other that prompt an action to be taken. Examples of these strings can be payment requests, Federation invite codes, group message invites, and more. When these codes are shared in a message, they can quickly become unwieldy and difficult to take action on. Copying a large string that\u2019s placed in between other text is a pain. Messages with a large payment request take up valuable screen real estate, and just look ugly. The goal here was to build an interface that translated clunky strings into native-feeling, actionable messages.</p>

<img src="/images/fedi-1.png" alt="Dynamic strings challenge" />
...
<img src="/images/fedi-2.png" alt="Bits discovery" />

<h3>Market research &amp; inspiration</h3>
<p>I wanted to see how other applications handled this challenge. Apple\u2019s iMessage has a similar function, as seen below.</p>

<img src="/images/fedi-3.png" alt="iMessage inspiration" />
...
<img src="/images/fedi-4.png" alt="Exploration variations" />

<img src="/images/fedi-5.png" alt="Exploration details" />

<p>To come to a decision, we landed on two principles:</p>
<ol>
<li>Let the content shine</li>
<li>Internationalization (Fedi is a global product)</li>
</ol>
...
<img src="/images/fedi-6.png" alt="Narrowing down options" />

<img src="/images/fedi-7.png" alt="Principles applied" />
...
<img src="/images/fedi-8.png" alt="Design spec overview" />

<img src="/images/fedi-9.png" alt="Design spec details" />
...
<img src="/images/fedi-10.png" alt="Dynamic message variations" />

<img src="/images/fedi-11.png" alt="Anatomy breakdown" />

<img src="/images/fedi-12.png" alt="Final design spec" />

<img src="/images/fedi-13.png" alt="Complete spec" />
`,
  },
  {
    slug: "wallet-history",
    ...
    featured: true,
    content: `
<p><strong>Wallet history \u2014 a timeline of keyset changes</strong></p>
...
<img src="/images/wallet-1.png" alt="Unchained vaults overview" />
<p><em>Source: Unchained blog</em></p>

<h2>Discovery, research, and the challenges</h2>

<h3>Key replacements can be risky</h3>
...
<p>These challenges were discovered after continuous user interviews with our primary personas: ultra high net worth individuals and businesses. The goal was to do \u201cjust enough research\u201d (without a dedicated UX researcher) to derisk as much as possible, to ship as fast as possible.</p>

<h2>Solution exploration</h2>

<img src="/images/wallet-2.png" alt="Birds-eye view of explorations" />
<p><em>Birds-eye view of different explorations and iterations</em></p>

<h3>First few rounds of iterations</h3>
...
<img src="/images/wallet-3.png" alt="First rounds of iterations" />
...
<img src="/images/wallet-4.png" alt="Sub-variants exploration" />
...
<h3>Evaluation of variations</h3>
...
<img src="/images/wallet-5.png" alt="Evaluation of variations" />
...
<img src="/images/wallet-6.png" alt="Wallet history solution" />
...
<h3>USB, browser compatibility, and New Tab</h3>
...
<img src="/images/hardware-1.png" alt="Trezor new tab issue" />
<p><em>Trezor frustratingly sending users off-platform to export public keys.</em></p>

<h3>Asynchronous QR codes and microSD</h3>
...
<img src="/images/hardware-2.png" alt="Asynchronous communication protocols" />
...
<img src="/images/hardware-4.png" alt="Internal feedback iterations" />
...
<img src="/images/hardware-5.png" alt="Twitter community feedback" />

<h2>Solution</h2>

<h3>Device registration (Async microSD card communication)</h3>
...
<h3>Confirm address on device (USB)</h3>
